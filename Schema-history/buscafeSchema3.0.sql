...
INSERT INTO tbl_usuario(nome, email, senha, ip, tipo, FK_id_estatus) VALUES
	("Marlom"  , "marlinho.123@gmail.com", md5('123456') , '192.168.0.2'    , 1 , 1 ),
    	("Igor"    , "igor.123@gmail.com"    , md5('123456') , '192.168.0.23'   , 1 , 1 ),
    	("Luis"    , "luis.123@gmail.com"    , md5('123456') , '192.168.0.245'  , 1 , 1 ),
    	("Gabriel" , "gabriel.123@gmail.com" , md5('123456') , '192.168.0.21'   , 2 , 1 ),
    	("Kaike"   , "kaike.123@gmail.com"   , md5('123456') , '192.168.0.22'   , 2 , 1 ),
    	("Jhonata" , "jhonata.123@gmail.com" , md5('123456') , '192.168.0.32'   , 2 , 1 ),
    	("Pedro"   , "pedro.123@gmail.com"   , md5('123456') , '192.168.0.14'   , 2 , 1 );
select * from tbl_usuario;
